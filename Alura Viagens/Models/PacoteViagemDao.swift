...
class PacoteViagemDao: NSObject {
    ...
    func retornaTodasAsViagens() -> [PacoteViagem] {
        ...
        let pacotePortoGalinhas = PacoteViagem(nomeDoHotel: "Resort Porto de Galinhas", descricao: "Hotel + café da manhã", dataViagem: "8~15 de agosto", viagem: Viagem(id: 1, titulo: "Porto de Galinhas", quantidadeDeDias: 7, preco: "2.490,99", caminhoDaImagem: "img6.jpg", localizacao: "Porto de galinhas"))
        
        let pacoteBuzios = PacoteViagem(nomeDoHotel: "Resort Buzios Spa", descricao: "Hotel + café da manhã", dataViagem: "9~16 de setembro", viagem: Viagem(id: 2, titulo: "Buzios", quantidadeDeDias: 7, preco: "1.990,99", caminhoDaImagem: "img7.jpg", localizacao: "Buzios - RJ"))
        
        let pacoteNatal = PacoteViagem(nomeDoHotel: "Resort Natal Show", descricao: "Hotel + café da manhã", dataViagem: "13~18 de setembroo", viagem: Viagem(id: 3, titulo: "Natal", quantidadeDeDias: 5, preco: "1.700,00", caminhoDaImagem: "img8.jpg", localizacao: "Natal - RN"))
        
        let pacoteRioDeJaneiro = PacoteViagem(nomeDoHotel: "Resort RJ Spa", descricao: "Hotel + café da manhã", dataViagem: "9~13 de outubro", viagem: Viagem(id: 4, titulo: "Rio de Janeiro", quantidadeDeDias: 4, preco: "2.300,00", caminhoDaImagem: "img9.jpg", localizacao: "Copacabana - RJ"))
        
        let pacoteAmazonas = PacoteViagem(nomeDoHotel: "Pousada Amazonas Plus", descricao: "Hotel + café da manhã", dataViagem: "9~13 de outubro", viagem: Viagem(id: 5, titulo: "Amazonas", quantidadeDeDias: 6, preco: "2.850,00", caminhoDaImagem: "img10.jpg", localizacao: "Amazonas - MG"))
        
        let pacoteSalvador = PacoteViagem(nomeDoHotel: "Pousada Salvador", descricao: "Hotel + café da manhã", dataViagem: "5~10 de novembro", viagem: Viagem(id: 6, titulo: "Salvador", quantidadeDeDias: 6, preco: "1.880,90", caminhoDaImagem: "img11.jpg", localizacao: "Praia do Flamengo - BH"))
